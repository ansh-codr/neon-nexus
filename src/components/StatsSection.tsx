...
export const StatsSection = () => {
  return (
    <section id="stats" className="relative py-16 border-y border-border bg-card/50">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-0 lg:divide-x divide-border">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-primary text-glow mb-2">
                {stat.value}
              </div>
