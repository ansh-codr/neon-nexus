    ...
    >
      <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8 px-4 sm:px-6">
        <div className="text-center">
          <GlitchText as="h3" className="text-2xl sm:text-3xl md:text-4xl text-primary mb-4">
            Your Health, Tracked
          </GlitchText>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          <div className="p-4 sm:p-6 border border-primary/30 cyber-chamfer bg-card/50 backdrop-blur-sm">
            <h4 className="font-display text-lg sm:text-xl text-primary uppercase tracking-wide mb-2 sm:mb-3">
              Overview
            </h4>
          ...
          <div className="p-4 sm:p-6 border border-secondary/30 cyber-chamfer bg-card/50 backdrop-blur-sm">
            <h4 className="font-display text-lg sm:text-xl text-secondary uppercase tracking-wide mb-2 sm:mb-3">
              Mission
            </h4>
            <p className="font-mono text-sm sm:text-base text-muted-foreground leading-relaxed">
